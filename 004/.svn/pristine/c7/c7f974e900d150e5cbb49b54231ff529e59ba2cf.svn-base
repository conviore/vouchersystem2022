...
<body>
	...
	<div class="easyui-panel" title="New Topic" style="width: 400px">
		<div style="padding: 10px 60px 20px 60px">
            ...
            <s:textfield label="parent code" name="parentCode" class="easyui-textbox" type="text" readonly="true"/>
            <s:textfield label="subject code" name="subjectCode" class="easyui-textbox" type="text" readonly="true"/>
